...
if(isset($_GET['sid'])){	
	$sid = $_GET['sid'];
	$detail = "SELECT * FROM PRODUCT_CATEGORY WHERE CATEGORY_ID = $sid";
...
if(isset($_POST['updateprod'])){
	...
	if ($error_count == 0){
		$detail = "UPDATE PRODUCT_CATEGORY SET NAME = '$pname', DESCRIPTION='$pdesc' WHERE CATEGORY_ID = $sid";
		$detailqry = oci_parse($conn, $detail);		
		oci_execute($detailqry);
		echo "<script>alert('You have sucessfully Edited a Product Category.');window.location.href='productcatagories.php';</script>";		
	}		
}
?>
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <button type="submit" name="updateprod" class="btn btn-primary">Update Product Category</button>
              </div>
            </form>
          </div>
      </section>
