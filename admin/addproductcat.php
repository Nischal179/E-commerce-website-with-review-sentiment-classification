...
if(isset($_POST['submit'])){
	$pname = $_POST["pname"];
	$pdesc = $_POST["pdesc"];	
	$detail = "INSERT INTO PRODUCT_CATEGORY VALUES(seq_product_category.nextval,'$pname','$pdesc')";
	$detailqry = oci_parse($conn, $detail);		
	oci_execute($detailqry);
	echo "<script>alert('You have sucessfully Added a Product Category.');window.location.href='productcatagories.php';</script>";			
}
?>
